...
const CtaSection = () => {
  ...
  return (
    <section className="bg-paraiso-yellow dark:bg-paraiso-blue/80 py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <Button asChild className="bg-paraiso-blue hover:bg-blue-800 dark:bg-paraiso-yellow dark:text-paraiso-blue dark:hover:bg-white">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <Button 
              className="bg-paraiso-blue hover:bg-blue-800 dark:bg-paraiso-yellow dark:text-paraiso-blue dark:hover:bg-white"
        ...
        <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-md mb-4 md:mb-0">
